...
$sql = mysqli_query($conn, "INSERT INTO relevenotes (demandeID, etudiantID,nomEtudiant,cin,dateNaissance,address, anneeAcademique) 
                            VALUES ('{$demandeID}', '{$etudiantID}', '{$nomEtudiant}', '{$cin}', '{$dateNaissance}', '{$address}', '{$anneeAcademique}')") or die();